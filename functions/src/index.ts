 ...
 */
export const getSignedUploadUrl = onRequest(async (request, response) => {
    // Enable CORS
 ...
 * @returns {object} An object containing a success flag and the signed URL.
 */
export const getSignedDownloadUrl = onRequest(async (request, response) => {
    // Enable CORS
    response.set('Access-Control-Allow-Origin', '*');
    response.set('Access-Control-Allow-Methods', 'GET, POST, OPTIONS');
    response.set('Access-Control-Allow-Headers', 'Content-Type, Authorization');
...
export const uploadFile = onRequest(async (request, response) => {
    // Enable CORS
    response.set('Access-Control-Allow-Origin', '*');
    response.set('Access-Control-Allow-Methods', 'GET, POST, OPTIONS');
    response.set('Access-Control-Allow-Headers', 'Content-Type, Authorization');
