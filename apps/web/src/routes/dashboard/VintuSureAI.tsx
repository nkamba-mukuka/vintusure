...
const VintuSureAI: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {activeView === 'rag' && 'Get instant answers from your insurance knowledge base'}
                {activeView === 'content-generator' && 'Generate insurance content with AI'}
                {activeView === 'car-analyzer' && 'Analyze car photos for insurance assessment'}
              </p>
            </div>
            {activeView === 'rag' && (
      ...
      {/* Floating Icons Menu - Right Side */}
